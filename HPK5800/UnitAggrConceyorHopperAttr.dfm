object FrmAggrConceyorHopperAttr: TFrmAggrConceyorHopperAttr
  Left = 928
  Top = 270
  BorderStyle = bsDialog
  Caption = 'FrmAggrConceyorHopperAttr'
  ClientHeight = 488
  ClientWidth = 432
  Color = clBtnFace
  ...
  object sPageControl1: TsPageControl
    ...
    object sTabSheet2: TsTabSheet
      ...
      object AdvStrGdAggrBinAttri: TAdvStringGrid
        ...
        ScrollBars = ssBoth
        TabOrder = 0
        OnGetAlignment = AdvStrGdAggrBinAttriGetAlignment
        OnCanEditCell = AdvStrGdAggrBinAttriCanEditCell
        OnCellsChanged = AdvStrGdAggrBinAttriCellsChanged
        OnGetEditorType = AdvStrGdAggrBinAttriGetEditorType
